...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-09-2025 a las 01:10:49
...
INSERT INTO `pagos` (`id_pago`, `id_venta`, `proveedor`, `transaccion_id`, `monto`, `moneda`, `estado`, `metodo`, `id_pedido`, `preference_id`) VALUES
(1, NULL, 'MercadoPago', '2702024581-ee3df1a9-0989-43f3-ace3-8069a3d5d278', 22800, 'COP', 'pendiente', 'checkout', 9, NULL),
(2, NULL, 'MercadoPago', '2702024581-bf63c4e7-2ada-4ca3-9b08-fa7cf5d97853', 32800, 'COP', 'pendiente', 'checkout', 12, NULL),
(3, NULL, 'MercadoPago', '2702024581-da45a8e2-83b9-4162-8be1-3bd29037642a', 47000, 'COP', 'pendiente', 'checkout', 13, NULL),
(4, NULL, 'MercadoPago', '2702024581-6427812c-e521-4d23-942a-e7aaa50ccc20', 47000, 'COP', 'pendiente', 'checkout', 14, NULL),
(5, NULL, 'MercadoPago', '2702024581-25abaa86-7308-4336-90b3-4fa9b5e53394', 64000, 'COP', 'pendiente', 'checkout', 15, NULL),
(6, NULL, 'MercadoPago', '2702024581-dbc95999-217a-42ce-ab61-7331d40f698e', 64000, 'COP', 'pendiente', 'checkout', 15, NULL),
(7, NULL, 'MercadoPago', '2702024581-d8384d1a-79d7-4db2-b173-869fa53a9b37', 64000, 'COP', 'pendiente', 'checkout', 15, NULL),
(8, NULL, 'MercadoPago', '2702024581-0aff9fcd-4678-4972-b683-958d325690ae', 64000, 'COP', 'pendiente', 'checkout', 16, NULL),
(9, NULL, 'MercadoPago', '2702024581-2ce385fe-f668-4549-845c-5602ba2adf9a', 64000, 'COP', 'pendiente', 'checkout', 17, NULL),
(10, NULL, 'MercadoPago', '126621705175', 64000, 'COP', 'approved', 'master', 18, '2702024581-24355a55-735f-4619-afdd-07dd47d87b03'),
(11, NULL, 'MercadoPago', '126624313835', 39800, 'COP', 'approved', 'master', 19, '2702024581-75b8cc4e-569d-4b64-93b7-a2dc33e4ac90');
...
--
ALTER TABLE `pedido_detalle`
  MODIFY `id_pedido_detalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
